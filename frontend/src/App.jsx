...
const defaultEntries = [
  ...
  {
    id: 2,
    title: 'Debugging for hours',
    date: '2025-01-07',
    mood: '😠',
    content:
      'Spent three hours hunting a missing semicolon. I will never forget to check the console first again.',
  },
  {
    id: 3,
    title: 'Things are clicking',
    date: '2025-01-10',
    mood: '😂',
    content: 'Array methods finally make sense! map, filter, and reduce are my new best friends.',
  },
];
